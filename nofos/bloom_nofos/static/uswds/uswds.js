      ...
      <div class="${STATUS_CLASS} usa-sr-only" role="status"></div>`
        ...
        const displayList = (el) => {
          ...
          const buildOptionsArray = (option) => {
            ...
            const matchStartsWith = option.text
              .toLowerCase()
 ...
 */
    ...
    `;
        ...
        const handleMouseoverFromDate = (dateEl) => {
          ...
          const { calendarEl, selectedDate, rangeDate } =
    ...
    20: [
      function (require, module, exports) {
        ...
        const DEFAULT_ERROR_LABEL_TEXT =
      ...
      function (require, module, exports) {
        ...
        const getTotalElementOffset = (el) => {
          const calculateOffset = (currentEl) => {
            ...
            return (
              currentEl.offsetTop + calculateOffset(currentEl.offsetParent)
            );
          };
        ...
        const createInPageNav = (inPageNavEl) => {
          ...
          const inPageNavMinimumHeadingCount = Sanitizer.escapeHTML`${
            inPageNavEl.dataset.minimumHeadingCount ||
            IN_PAGE_NAV_MINIMUM_HEADING_COUNT
          }`;
